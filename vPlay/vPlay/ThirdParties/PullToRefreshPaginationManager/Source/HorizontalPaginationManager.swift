...
public protocol HorizontalPaginationManagerDelegate: NSObjectProtocol {
	func horizontalPaginationManagerShouldStartLoading(_ controller: HorizontalPaginationManager) -> Bool
...
extension HorizontalPaginationManager: ScrollViewStateControllerDelegate {
    ...
    public func stateControllerShouldStartLoading(_ controller: ScrollViewStateController) -> Bool {
        return self.delegate?.horizontalPaginationManagerShouldStartLoading(self) ?? true
    }
}
